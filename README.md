...
**A multi-agent MCP toolkit that takes a Python project from idea to production.** Seven tools collaborate through a shared knowledge base to capture ideas, architect, plan, review, fix, document, harden, and release your code -- enforcing **SOLID + DRY** in your code and **Andrej Karpathy's coding-agent guidelines** in the AI itself (surgical changes, surface assumptions, never delegate understanding).
...
- [Quick Start](#quick-start)
  - [Install](#install)
  - [Add MCP servers (Claude Code)](#add-mcp-servers-claude-code)
  - [Add MCP servers (Cursor / Windsurf / Cline)](#add-mcp-servers-cursor--windsurf--cline)
- [Pipeline Workflow](#pipeline-workflow)
  - [High-level overview](#high-level-overview)
  - [Detailed flow -- every capability inside each stage](#detailed-flow----every-capability-inside-each-stage)
  - [Composable artifacts in action -- a realistic Fix-stage sequence](#composable-artifacts-in-action----a-realistic-fix-stage-sequence)
  - [Stage 0a: Idea Capture (optional, greenfield)](#stage-0a-idea-capture-optional-greenfield)
  - [Stage 0b: Spec Analysis (optional, embedded)](#stage-0b-spec-analysis-optional-embedded)
  - [Stage 1: Architecture Analysis](#stage-1-architecture-analysis)
  - [Stage 2: Implementation Plan (optional, recommended for greenfield)](#stage-2-implementation-plan-optional-recommended-for-greenfield)
  - [Stage 3: Code Review](#stage-3-code-review)
  - [Stage 4: Fix](#stage-4-fix)
  - [Stage 5: Verify](#stage-5-verify)
  - [Stage 6: Documentation (optional, run once near release)](#stage-6-documentation-optional-run-once-near-release)
...
- [Composable Artifacts](#composable-artifacts)
  ...
  - [Completion Tracking -- agent self-direction](#completion-tracking----agent-self-direction)
  - [Structured Message payloads](#structured-message-payloads)
  - [Task-conditioned skill composition](#task-conditioned-skill-composition)
  - [Cross-process safety](#cross-process-safety)
- [Architecture](#architecture)
  - [Debates](#debates)
- [Expert Profiles](#expert-profiles)
  - [ArchSwarm -- design-time architecture (10 experts)](#archswarm----design-time-architecture-10-experts)
  - [ReviewSwarm -- code-time bug detection (13 experts)](#reviewswarm----code-time-bug-detection-13-experts)
  - [FixSwarm -- repair-time code changes (8 experts)](#fixswarm----repair-time-code-changes-8-experts)
  - [DocSwarm -- documentation generation + verification (8 experts)](#docswarm----documentation-generation--verification-8-experts)
  - [SpecSwarm -- hardware / embedded specs (14 experts, optional)](#specswarm----hardware--embedded-specs-14-experts-optional)
  - [Customising and adding experts](#customising-and-adding-experts)
- [Requirements](#requirements)
- [Skills -- composable methodology overlays](#skills----composable-methodology-overlays)
  - [Universal skills (auto-attached to all 53 experts)](#universal-skills-auto-attached-to-all-53-experts)
  - [Opt-in skills (declared per-expert via `uses_skills:`)](#opt-in-skills-declared-per-expert-via-uses_skills)
  - [Composition algorithm (in one paragraph)](#composition-algorithm-in-one-paragraph)
